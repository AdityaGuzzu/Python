...
print(numbers[-1:5:-1]) #Note that 77 was printed because we were gpoing from BACK and 5 was counted from the front
print(numbers[:2]) #leaving the first block blank implies start = 0
print(numbers[2:]) #leaving second block empty implies stop = -1
print(numbers[:7:3]) #This statement implies - print all values starting from 0 to 1 by skipping every two values in between
